...
# Mon Oct 10 05:08:38 2022
# Specifically, the command was:
# < directory=/home/zhongrenhu >
# QuickDotplot clm.9.dotplot.txt


library( ggplot2, quietly=TRUE ) # ggplot

dotplot.file <- 'clm.9.dotplot.txt'
jpeg.file <- 'clm.9.dotplot.txt.jpg'
...
# Assign text labels.
p <- p + ggtitle( "QuickDotplot of clm.9.dotplot.txt" )
p <- p + xlab("")
p <- p + ylab("")
